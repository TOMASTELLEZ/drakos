        ...
        <div class="owl-carousel" id="top-movies-slide">
          ...
          <div class="movie-item">
            <a href="../index/login.php">
              <img src="../images/movies/Capitán América.jpg" alt="" />
              <div class="movie-item-content">
                <div class="movie-item-title">Capitan America: CIlvi War</div>
          ...
          <div class="movie-item">
            <a href="../index/login.php">
              <img src="../images/movies/El niño que domó el viento.jpg" alt="" />
              <div class="movie-item-content">
          ...
          <div class="movie-item">
            <a href="../index/login.php">
              <img src="../images/movies/hangover 2.jpg" alt="" />
              <div class="movie-item-content">
