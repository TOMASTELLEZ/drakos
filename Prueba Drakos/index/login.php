...
<body>
    ...
    <svg>
        <defs>
          <g id="Cabeza" transform="matrix(0.5, 0, 0, 0.5, 0, 0)">
          ...
          <g id="Espina" transform="matrix(0.5, 0, 0, 0.5, 0, 0)">
  ...
  <div class="wrapper">
    <div class="form-header">
      <img src="../images/logo.png" alt="Logo" class="header-img">
    </div>
    <?php
    ...
    ?>
    <!-- LOGIN FORM -->
    <form action="../conexion/controlador.php" method="POST" class="login-form" autocomplete="off">
      <div class="input-box">
        <input id="usuario" type="text" class="input-field"  name="log-mail" required>
        <label for="log-mail" class="label">Email</label> 
        <i class='bx bx-envelope icon'></i>
      </div>
      <div class="input-box">
        <input type="password" id="input" class="input-field"  name="log-pass" required>
      ...
      <div class="input-box">
        <input name="Boton_login" class="btn-submit" type="submit" value="LOG IN">
    </div>
    
      <!-- Botones de acceso social -->
      <div class="social-login">
        <button type="button" class="btn-social google"><i class='bx bxl-google'></i> Continue with Google</button>
        <button type="button" class="btn-social facebook"><i class='bx bxl-facebook'></i> Continue with Facebook</button>
      </div>
    ...
    <!-- REGISTER FORM -->
    <form action="../conexion/controlador.php" method="POST" class="register-form" autocomplete="off">
      <div class="input-box">
        <input id="Name" type="text" class="input-field-r" name="reg-name" required>
        <label for="reg-name" class="label">Name</label>
        <i class='bx bx-user icon'></i>
      </div>
      <div class="input-box">
        <input id="user" type="text" class="input-field-r" name="reg-user" required>
        <label for="reg-name" class="label">Username</label>
        <i class='bx bx-user icon'></i>
      </div>
      <div class="input-box">
        <input id="usuario" type="text" class="input-field-r"  name="reg-mail" required>
        <label for="reg-email" class="label">Email</label>
        <i class='bx bx-envelope icon'></i>
      </div>
      <div class="input-box">
        <input type="password" id="input" class="input-field-r"  name="reg-pass" required>
        <label for="reg-pass" class="label">Password</label>
        <i class='bx bx-lock-alt icon'></i>
      </div>
      <div class="form-cols">
        <div class="col-1">
          <input type="checkbox" id="agree" name="check-box" required>
          <div class="switch-form">
            <a href="Help.php">I agree to terms & conditions</a>
          </div>
        </div>
        <div class="col-2"></div>
      </div>
      <div class="input-box">
        <input name="boton_registro" class="btn-submit" type="submit" value="REGISTER">
      </div>
