...
<body>
  ...
  <div class="wrapper">
    ...
    <?php
      ...
      include("../conexion/controlador_forgot_pass.php");
    ?>
    <!-- LOGIN FORM -->
    <form action="../conexion/controlador_forgot_pass.php" method="POST" class="login-form" autocomplete="off">
      <div class="input-box">
        <input id="usuario" type="text" class="input-field"  name="old-pass" required>
        <label for="old-pass" class="label"><?php echo $ing1;?></label> 
        <i class='bx bx-lock-alt icon'></i>
      </div>
      <div class="input-box">
        <input type="password" id="input" class="input-field"  name="new-pass" required>
        <label for="new-pass" class="label"><?php echo $ing2;?></label>
        <i class='bx bx-lock-alt icon'></i>
      </div>
      <div class="form-cols">
        <div class="col-1"></div>
        ...
        <div class="input-box">
            <input name="btn-new-pass" class="btn-submit" type="submit" value="LOG IN">
        </div>
  </div>
